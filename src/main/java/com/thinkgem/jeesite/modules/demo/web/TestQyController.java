...
import com.thinkgem.jeesite.modules.demo.service.TestQyService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/demo/testQy")
public class TestQyController extends BaseController {
	...
	@RequiresPermissions("demo:testQy:view")
	...
	public String list(TestQy testQy, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/demo/testQyList";
	}
	...
	public String form(TestQy testQy, Model model) {
		...
		return "modules/demo/testQyForm";
	}

	@RequiresPermissions("demo:testQy:edit")
	...
	public String save(TestQy testQy, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/demo/testQy/?repage";
	}
